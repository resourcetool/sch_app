        ...
        <div className="auth-right" style={{ textAlign: 'center' }}>
          ...
          <div style={{ background: 'var(--surface2)', borderRadius: 12, padding: 20, marginBottom: 24 }}>
            ...
            <a href="https://wa.me/233240000000" target="_blank" rel="noreferrer"
              style={{ display: 'block', background: '#25D366', color: '#fff', padding: '10px 20px', borderRadius: 8, fontWeight: 700, textDecoration: 'none', marginBottom: 8 }}>
              📱 WhatsApp: 024XXXXXXX
            </a>
            <a href="tel:+233240000000"
              style={{ display: 'block', background: 'var(--navy)', color: '#fff', padding: '10px 20px', borderRadius: 8, fontWeight: 700, textDecoration: 'none' }}>
              📞 Call: 024XXXXXXX
            </a>
          </div>
    ...
    <div className="auth-page">
      <div className="auth-left">
        ...
        <div style={{ marginTop: 36 }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, fontSize: '.88rem', opacity: .9 }}>
        ...
        <div style={{ marginTop: 32, background: 'rgba(255,255,255,.1)', borderRadius: 12, padding: '16px 20px' }}>
          ...
          <div style={{ fontSize: '1.8rem', fontWeight: 900 }}>GHS 150<span style={{ fontSize: '1rem', fontWeight: 400 }}>/month</span></div>
      ...
      <div className="auth-right" style={{ width: '480px', overflowY: 'auto' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div className="form-grid">
            <div className="form-group full">
              ...
              <input required value={form.schoolName} onChange={e => update('schoolName', e.target.value)} placeholder="e.g. Kumasi Preparatory School" />
            </div>
            ...
            <div className="form-group">
              ...
              <select value={form.region} onChange={e => update('region', e.target.value)}>
                ...
                {['Ashanti', 'Greater Accra', 'Northern', 'Western', 'Eastern', 'Central', 'Volta', 'Brong-Ahafo', 'Upper East', 'Upper West', 'Savannah', 'Bono East', 'Ahafo', 'North East', 'Oti', 'Western North'].map(r => (
            ...
            <div className="form-group">
              ...
              <input type="number" value={form.studentCount} onChange={e => update('studentCount', e.target.value)} placeholder="e.g. 350" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group full">
              ...
              <textarea rows={3} value={form.message} onChange={e => update('message', e.target.value)}
                placeholder="Any questions or special requirements..." style={{ resize: 'vertical' }} />
            </div>
          </div>
        ...
        <div style={{ marginTop: 16, textAlign: 'center', fontSize: '.82rem', color: 'var(--text-mid)' }}>
          Already have an access code? <Link to="/register" style={{ color: 'var(--navy)', fontWeight: 700 }}>Register here →</Link>
        </div>
